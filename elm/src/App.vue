<template>
  <div style="height:100%;">
    ...
    <tabbar @on-index-change="tabbarDidSelecte" v-show="isShowTabbar" slot="bottom">

      <tabbar-item :selected="isShowTabbar" icon-class="vux-center">
        <svg slot="icon" class="icon-style">
          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#msite"></use>
        </svg>
        <svg slot="icon-active" class="icon-style">
      ...
      <tabbar-item badge="2">
        ...
        <svg slot="icon-active" class="icon-style">
          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#orderActive"></use>
        </svg>
      ...
      <tabbar-item>
        ...
        <svg slot="icon-active" class="icon-style">
          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#profileActive"></use>
        </svg>
...
<script>
  ...
  import mySvg from './common/svg.vue'
  export default {
    components: {
      TabbarItem,
      Tabbar,
